...
const iconClass = "h-4 w-4 text-white/60 transition-colors group-hover:text-green-400";

function FooterIconLink({ href, label, external = false, children }: FooterIconLinkProps) {
  return (
    <a
      href={href}
...
export default function HomeFooter({ discordInviteUrl }: HomeFooterProps) {
  return (
      ...
      <div className="mx-auto max-w-4xl">
        <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
          ...
          <div className="flex gap-3">
            <FooterIconLink href={discordInviteUrl} label="Discord" external>
            ...
            <FooterIconLink href="mailto:hactor@example.com" label="Email">
              <svg
                className={iconClass}
                fill="none"
                stroke="currentColor"
            ...
            <FooterIconLink href="https://github.com/hactor" label="GitHub" external>
              <svg className={iconClass} fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
